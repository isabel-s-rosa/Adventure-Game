...
public class MyWorld extends World implements Data{
    ...
    public MyWorld(){
        super(500, 400, 1);
        setPaintOrder(GreenfootImage.class, Black.class, Person.class, Desk.class, BagThings.class, Door.class, Pamphlet.class, Room.class);
